...
// ตะแบก = สะเดา +70% (×1.7) | สัก B = ตะแบก +40% (×1.4 = สะเดา ×2.38) | สัก A = สัก B +50% (×1.5 = สะเดา ×3.57)
...
export const LABEL_MAP: Record<string, string> = {
  ...
  'wavy_half_6': 'กระจกลอนครึ่งบาน (6 ช่อง)',
  'full': 'เกล็ดเต็มบาน',
  'half': 'เกล็ดครึ่งบาน',
  'side': 'เกล็ดข้าง',
  'bottom': 'เกล็ดล่าง',
  ...
  'wf_sadao_paint':  'วงกบสะเดา — ค่าทำสี (บวกเพิ่ม ทุกขนาดเท่ากัน)',
...
export const DEFAULT_PRICES: PricingStructure = {
  ...
  glass: { 'none': 0, 'frosted': 999, 'frosted_half': 999, 'frosted_side': 999, 'green_full': 999, 'green_half': 999, 'green_side': 999, 'wavy_half': 999, 'wavy_half_6': 0 },
